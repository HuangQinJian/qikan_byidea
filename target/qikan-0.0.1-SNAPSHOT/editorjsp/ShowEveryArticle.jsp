...
<head>
    ...
    <link href="../css/editordetail.css" rel="stylesheet" type="text/css"/>
    <!-- jQueryUI -->
...
<div id="sidebar">
    ...
    <div class="sidebar-inner">
        ...
        <ul id="sideNav" class="nav nav-pills nav-stacked">
            ...
            <li><a href="EditorLogin.jsp"> <span class="activeType">编辑者登录</span> <i class="im-quill"></i></a>
            </li>
                    ...
                    <div class="panel-body" id="article_detail">
                        ...
                        <script id="test" type="text/html">
                            <form action="ArticleEditCheck" method="POST" id="form">
                                ...
                                <div id="detail">
                                    <div id="author">
                                        文章作者：<input type="text" value={{list.autor.autoname}} name="author">
                                    </div>
                                    <div id="publish_time">
                                        发布时间：<input type="text" value={{list.publishdate}} name="publishdate">
                                    </div>
                                ...
                                <input type="hidden" value=<%= name%> name="editor">
