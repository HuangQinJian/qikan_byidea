...
<head>
    <meta charset="utf-8">
    <title>期刊管理系统-编辑者登录界面</title>
    <!-- Mobile specific metas -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <!-- Force IE9 to render in normal mode -->
    <!--[if IE]>
    <meta http-equiv="x-ua-compatible" content="IE=9"/><![endif]-->
    <meta name="editor" content="SuggeElson"/>
    ...
    <div class="login-wrapper">
        ...
        <div id="myTabContent" class="tab-content bn">
            <div class="tab-pane fade active in" id="log-in">
                <form method="post" class="form-horizontal mt10" action="EditorLoginCheck" id="login-form" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                            ...
                            <span class="help-block"><a href="EditorRegiest.jsp"><small>没有账号？快去注册一个吧！</small></a></span>
                        </div>
                        <!-- col-lg-12 end here -->
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-4">
                            <!-- col-lg-12 start here -->
                            <button class="btn btn-success pull-right" type="submit" name="submit">登录</button>
                        </div>
                        <!-- col-lg-12 end here -->
                    </div>
                </form>
