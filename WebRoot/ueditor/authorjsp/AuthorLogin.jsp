    ...
    <div class="login-wrapper">
        ...
        <div id="myTabContent" class="tab-content bn">
            <div class="tab-pane fade active in" id="log-in">
                <form method="post" class="form-horizontal mt10" action="AuthorLoginCheck" id="login-form" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                            ...
                            <span class="help-block"><a href="AuthorRegiest.jsp"><small>没有账号？快去注册一个吧！</small></a></span>
                        </div>
                        <!-- col-lg-12 end here -->
