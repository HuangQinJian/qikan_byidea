    ...
    <div class="login-wrapper">
        ...
        <div id="myTabContent" class="tab-content bn">
            <div class="tab-pane fade active in" id="log-in">
                <form method="post" class="form-horizontal mt10" action="AuthorRegiest" id="login-form" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                            ...
                            <span class="help-block"><a href="AuthorLogin.jsp"><small>已有账号？赶快登录吧！</small></a></span>
                        </div>
                        <!-- col-lg-12 end here -->
